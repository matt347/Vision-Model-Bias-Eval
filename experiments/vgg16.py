...
def parse_args():
	parser = argparse.ArgumentParser(description="Fine-tune VGG16 on FairFace gender")
...
def main():
	...
	for epoch in range(1, args.epochs + 1):
		...
		if val_metrics.accuracy > best_val_acc:
			...
			torch.save(
				...
				os.path.join(args.output_dir, "vgg16_best.pt"),
			)
	...
	torch.save(
		...
		os.path.join(args.output_dir, "vgg16_last.pt"),
	)
