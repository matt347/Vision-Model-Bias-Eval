...
def parse_args():
	parser = argparse.ArgumentParser(
		description="Run the race-specific ViT gender bias experiment once per race and aggregate results"
	)
	parser.add_argument("--script", type=str, default="experiments/compare_race_vit.py")
