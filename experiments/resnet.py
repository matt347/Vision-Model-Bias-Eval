...
def build_datasets(dataset_name, dataset_config, val_split_ratio, image_size, seed):
...
def parse_args():
	parser = argparse.ArgumentParser(description="Fine-tune ResNet-50 on FairFace gender")
...
def main():
	...
	optimizer = torch.optim.AdamW(
		filter(lambda p: p.requires_grad, model.parameters()), # only finetune head
		lr=args.lr,
	...
	torch.save(
		...
		os.path.join(args.output_dir, "resnet50_last.pt"),
	)
